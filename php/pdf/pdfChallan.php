...
$query12="SELECT * FROM `challan` WHERE `invoice_no`='$invoice_no' AND `challan_no`='$challanNo'"; 
if($query_run12=mysql_query($query12)){
while($query_row12=mysql_fetch_assoc($query_run12)){
$date=$query_row12['date'];
}
	...
	$old_date=$date;
	//date formet changing 
	$old_date_timestamp = strtotime($old_date);
	$tym = date('d F Y ', $old_date_timestamp);   
