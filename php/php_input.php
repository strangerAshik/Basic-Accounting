...
$query="INSERT INTO `inventory_surface` (`date`,`company`,`work_order`,`purchase_invoice`,`challan`,`part_no`,`item_name`,`brand`,`quantity`,`purchaseUnitPrice`,`saleUnitPrice`) VALUES ('$today','$company','$workOrder','$purchaseInvoice','$supplierChallan','$partNo','$itemName','$brand','$quantity','$unitPrice','$saleUnitPrice')";
	...
	if($query_run=mysql_query($query))		
		...
		while($query_row=mysql_fetch_assoc($query_run))
							...
							//	$delevaedQuantity=$query_row['delevaed_quantity'];
								...
								$query1="INSERT INTO `challan` (`date`,`invoice_no`,`item`,`part`,`brand`,`delivered_quantity`,`challan_no`) VALUES ('$today','$invoiceNo','$item_name','$part_no','$brand','$NewDelevaedQuantity','$newChallanNo')";
